...
export default function App(){
  ...
  const view=()=>{
    ...
    if(scr==="login")return <div className="fu" style={{padding:"30px 0"}}>
      ...
      <button onClick={()=>setScr("login-name")} style={pbtn(true)}>Get Started</button>
      <p style={{fontSize:11,color:"rgba(255,255,255,0.15)",textAlign:"center",marginTop:16}}>No account needed — your data saves on this device</p>
    </div>;
